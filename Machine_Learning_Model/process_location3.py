"""
Complete Processing Pipeline for Location3.csv Sensor Data
"""
import pandas as pd
import numpy as np
import pickle
...
class SmartDamProcessor:
    ...
    def process_and_predict(self, input_file: str, output_file: str = None) -> pd.DataFrame:
        ...
        print("\n" + "="*70)
        print("📈 PREVIEW OF RESULTS (First 20 rows):")
        print("="*70)
...
def main():
    ...
    results = processor.process_and_predict(
        input_file='Location3.csv',
        output_file='Location3_processed.csv'
    )
